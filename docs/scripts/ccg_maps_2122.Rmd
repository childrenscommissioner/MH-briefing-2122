...
* CCG spend on children's mental health as a percentage of CCG budget. This ranges from 2.2% in NHS SALFORD to 0.4% in NHS BLACKPOOL.

* Mental health spend per child (calculated using NHS Five Year Forward View (FYFV) spending figures and ONS mid-2020 CCG population estimates. This ranges from £141 in NHS NORFOLK AND WAVENEY to NHS DONCASTER £34 per child.

* Total number of children referred to CAMHS as a proportion of the under-18 population. This ranges from 3.4% in NHS NORTH WEST LONDON to 11.5% in NHS SOUTH TYNESIDE. 

* Average waiting time for children who receive a second contact. This ranges from 80 days in NHS SUNDERLAND to 13 days in NHS WEST LEICESTERSHIRE and NHS LEICESTER CITY (previously 6 days in NHS Castle Point and Rochford).

* The percentage of referrals that are closed before treatment. This ranges from 5% in NHS Leeds to 50% in (previously 41% in NHS Barnsley).
<br/><br/>
...
map <- readOGR(dsn = "W:/CCO-WORKING-FS/Projects/MH briefing/MH briefing 202122/ccg maps/CCG shape files")
...
mhdata2122 <- read.csv("W:/CCO-WORKING-FS/Projects/MH briefing/MH briefing 202122/analysis/ccg maps/summarytables_202122.csv", stringsAsFactors = F)


### Link 2021/22 CCG names to old names 
